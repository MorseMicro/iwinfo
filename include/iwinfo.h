...
enum iwinfo_freq_flag {
	...
	IWINFO_FREQ_NO_4MHZ,
	IWINFO_FREQ_NO_8MHZ,
	IWINFO_FREQ_NO_16MHZ,
	IWINFO_FREQ_S1G_NO_PRIMARY,
...
#define IWINFO_FREQ_NO_4MHZ        (1 << IWINFO_FREQ_NO_4MHZ)
#define IWINFO_FREQ_NO_8MHZ        (1 << IWINFO_FREQ_NO_8MHZ)
#define IWINFO_FREQ_NO_16MHZ       (1 << IWINFO_FREQ_NO_16MHZ)
#define IWINFO_FREQ_S1G_NO_PRIMARY (1 << IWINFO_FREQ_S1G_NO_PRIMARY)
